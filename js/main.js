  ...
  if ($(".home-page").length > 0) {
    if ($(window).width() > 768 && window.orientation !== 0) {
      ...
      let titles = gsap.utils.toArray(".page-title li"),
        ...
        projectBlocks = gsap.utils.toArray(
          ".projects__blocks .projects__block"
        ),
      ...
      projectBlocks.forEach((block, index) => {
        ...
        if (index > 0) {
          projectHeights[index] =
            tempHeight - $(".projects__blocks").innerHeight() / 2;
      ...
      newsBlocks.forEach((block, index) => {
        ...
        if (index > 0) {
          newsHeights[index] =
            tempHeight - $(".news__blocks").innerHeight() / 2;
      ...
      let scrollDurationHome = 1000 * (parseInt(hSpeed) / 100),
        addBlocksScroll = 200,
        projectBlocksScroll =
          projectHeightsTotal - $(".projects__blocks").innerHeight() < 0
            ? 0
            : (projectHeightsTotal - $(".projects__blocks").innerHeight()) *
              (parseInt(vSpeed) / 100),
        newsBlocksScroll =
          newsHeightsTotal - $(".news__blocks").innerHeight() < 0
            ? 0
            : (newsHeightsTotal - $(".news__blocks").innerHeight()) *
              (parseInt(vSpeed) / 100);
      ...
      let st = ScrollTrigger.create({
        ...
        start: "top top",
          ...
          "+=" +
          (scrollDurationHome * (sections.length - 1) +
            projectBlocksScroll +
            newsBlocksScroll +
            addBlocksScroll * 4),
      ...
      tlTitle2.fromTo(
        titles[sectionNumber],
        { y: "100%" },
        { y: "0", duration: 0.2 }
      );
      tlTitle2.fromTo(
        titles[sectionNumber - 1],
        { y: "0" },
        { y: "-100%", duration: 0.2 },
        0
      );
      ...
      gsap.delayedCall(0.4, function () {
        ...
        titles.forEach((title, index) => {
          if (index % 2 === 0) {
            tl1.from(
              title,
              1,
              { autoAlpha: 0, left: -600, ease: Power1.easeOut },
              0.2 * index
            );
          } else {
            tl1.from(
              title,
              1,
              { autoAlpha: 0, right: -600, ease: Power1.easeOut },
              0.2 * index
            );
          }
        });
        ...
        TweenMax.staggerFrom(
          elements,
          1,
          { autoAlpha: 0, bottom: -300, ease: Back.easeOut },
          0.3
        );
      });
      gsap.delayedCall(0.5, function () {
      ...
      tl1.to(
        ".home__circle--left, .home__circle--rigth",
        {
          x: 0,
          ease: "none",
        },
      ...
      titlesProjects.forEach((title, index) => {
        if (index % 2 === 0) {
          tl1.from(
            title,
            { autoAlpha: 0, right: -600 - 100 * index, ease: Power1.easeOut },
            0
          );
        } else {
          tl1.from(
            title,
            { autoAlpha: 0, left: -600 - 100 * index, ease: Power1.easeOut },
            0
          );
        }
      });

      let menuProjects = gsap.utils.toArray(
        ".projects .projects__menu > li > *"
      );
      menuProjects.forEach((title, index) => {
        tl1.from(
          title,
          { autoAlpha: 0, right: -700 - 150 * index, ease: Power1.easeOut },
          0
        );
      });
      ...
      let st3 = ScrollTrigger.create({
        ...
        start:
          "0 -" +
          (scrollDurationHome + projectBlocksScroll + addBlocksScroll * 2),
        end: "+=" + scrollDurationHome,
        onUpdate: ({ progress, direction, isActive }) => {
          if (progress >= 0.9) {
            tlAvardsBtn.play();
      ...
      tl31.from(
        ...
        { autoAlpha: 0, top: -200, ease: Power1.easeOut },
        0
      );
      ...
      awardsAwards.forEach((award, index) => {
        tl31.from(
          award,
          { autoAlpha: 0, bottom: -800 - 300 * index, ease: Power1.easeOut },
          0
        );
      });
      //awards end
      ...
      let st4 = ScrollTrigger.create({
        ...
        start:
          "0 -" +
          (scrollDurationHome * (sectionNumber - 1) +
            projectBlocksScroll +
            addBlocksScroll * 2),
        end: "+=" + scrollDurationHome,
        onToggle: ({ progress, direction, isActive }) => {
      ...
      let clientsTesti = gsap.utils.toArray(
        ".testimonials__clients > .testimonials__client"
      );
      clientsTesti.forEach((client, index) => {
        tl4.from(
          client,
          { autoAlpha: 0, bottom: -600 - 200 * index, ease: Power1.easeOut },
          0
        );
      });
      ...
      let st61 = ScrollTrigger.create({
        ...
        start:
          "0 -" +
          (scrollDurationHome * sectionNumber +
            projectBlocksScroll +
            addBlocksScroll * 3),
      ...
      tl7.from(
        ".contacts .contacts__copyright",
        { autoAlpha: 0, bottom: -300, ease: Power1.easeOut },
        0
      );

      let menuContacts = gsap.utils.toArray(
      ...
      tl71.from(
        ".contacts .content__brief",
        { autoAlpha: 0, left: -400, ease: Power1.easeOut },
        0
      );
      tl71.from(
        ".contacts .content__form",
        { autoAlpha: 0, right: -400, ease: Power1.easeOut },
        0
      );
      //contacts end
      ...
      let stScrollLast = ScrollTrigger.create({
        ...
        start:
          "0 -" +
          (scrollDurationHome * (sections.length - 2) +
            projectBlocksScroll +
            newsBlocksScroll +
            addBlocksScroll * 4),
        end: "+=" + scrollDurationHome,
      ...
      $(document).on("click", ".js-scroll-link", function () {
        ...
        if (!blockNavigation && !skipMode) {
          ...
          setTimeout(function () {
            ...
            gsap.set(
              sections,
              { xPercent: -100 * parseInt(link), ease: "none" },
              0
            );
            $(".header__menu li").removeClass("active");
      ...
      $(document).on("click", ".projects__menu a", function () {
        ...
        let parent = $(this).parent(),
          progress =
            projectHeightsScroll[parent.index()] /
            (projectHeightsTotal - $(".projects__blocks").innerHeight()),
          scrollTo =
            parseInt(linkData[1]) +
            addBlocksScroll * 2 +
            projectBlocksScroll * progress;
        st.scroll(scrollTo);
      });
      $(document).on("click", ".news__menu a", function () {
        ...
        let parent = $(this).parent(),
          progress =
            newsHeightsScroll[parent.index()] /
            (newsHeightsTotal - $(".news__blocks").innerHeight()),
          scrollTo =
            parseInt(linkData[5]) +
            addBlocksScroll +
            newsBlocksScroll * progress;
        st.scroll(scrollTo);
      });
    } else {
      $(document).on("click", ".js-scroll-link", function () {
